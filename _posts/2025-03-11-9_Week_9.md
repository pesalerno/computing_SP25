...
> NOTE: when you are ready to leave the virtual you can either type `deacivate` in the command line, or you can close the `shell` window you are working on. 
...
# Thursday pm | numpy, pandas, matplotlib
